<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fetch Yesterday attendence.aspx.cs" Inherits="M3_team3.Fetch_Yesterday_attendence" %>
        ...
        <div class="leave-page-wrapper">
            <div class="leave-card">
                <asp:Label ID="Label1" runat="server" 
                           Text="Yesterday's Attendance Records" 
