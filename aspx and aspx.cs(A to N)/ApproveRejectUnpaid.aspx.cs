        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (status == "Approved")
                {
                    ...
                    lblMessage.Text = "Unpaid leave request " + requestID + " has been APPROVED!";
                }
                else if (status == "Rejected")
                {
                    lblMessage.ForeColor = System.Drawing.Color.Red;
                    lblMessage.Text = "Unpaid leave request " + requestID + " has been REJECTED (duration > 30 days, has annual balance, or already has approved unpaid leave this year)!";
                }
                else
                {
                    lblMessage.ForeColor = System.Drawing.Color.Orange;
                    lblMessage.Text = "Unpaid leave request " + requestID + " is still PENDING.";
                }
