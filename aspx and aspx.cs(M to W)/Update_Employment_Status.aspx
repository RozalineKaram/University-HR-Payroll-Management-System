<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update_Employment_Status.aspx.cs" Inherits="M3_team3.Update_Employment_Status" %>
        ...
        <div class="leave-page-wrapper">
            <div class="leave-card">
                <asp:Label ID="Label2" runat="server" 
                           Text="Update Employment Status" Font-Bold="true" Font-Size="Large"></asp:Label>
                <br /><br />
